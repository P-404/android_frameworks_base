...
public class KeyguardSliceProviderP404 extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KeyguardSliceProviderP404> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KeyguardSliceProviderP404 keyguardSliceProviderP404, SmartSpaceCard smartSpaceCard) {
            mProviderReference = new WeakReference<>(keyguardSliceProviderP404);
            mWeatherCard = smartSpaceCard;
            mBlurRadius = keyguardSliceProviderP404.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            KeyguardSliceProviderP404 keyguardSliceProviderP404;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProviderP404 = (KeyguardSliceProviderP404) mProviderReference.get();
            }
            if (keyguardSliceProviderP404 != null) {
                keyguardSliceProviderP404.notifyChange();
            }
        }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KeyguardSliceProviderP404#onBindSlice");
        Slice slice;
